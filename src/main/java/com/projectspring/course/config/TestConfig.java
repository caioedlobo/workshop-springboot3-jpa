...
public class TestConfig implements CommandLineRunner {       // vai servir para fazer o database seeding (popular o banco de dados)
    ...
    public void run(String... args) throws Exception {
        ...
        // como o Payment é dependente do Order, não chamamos o Repository dele, chamamos o do Order
        o1.setPayment(pay1);
        ...
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));       //modo do JPA, se fosse com SQL seria diferente
